...
class SlotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create slot" do
    assert_difference("Slot.count") do
      post slots_url, params: { slot: { calendar_id: @slot.calendar_id, data_end: @slot.data_end, data_start: @slot.data_start, profile_id: @slot.profile_id, public: @slot.public, visibility: @slot.visibility } }
    end
  ...
  test "should update slot" do
    patch slot_url(@slot), params: { slot: { calendar_id: @slot.calendar_id, data_end: @slot.data_end, data_start: @slot.data_start, profile_id: @slot.profile_id, public: @slot.public, visibility: @slot.visibility } }
